...
<input type="hidden" id="pid" value="${requestScope.appointMent.patient.pid}">
  ...
  <div class="layui-form-item" style="width: 500px;">
    ...
    <div class="layui-input-block">
      <input type="date" id="effectdate" name="effectdate" value="${requestScope.appointMent.effectDate }" required  lay-verify="required" placeholder="请输入预约时间" autocomplete="off" class="layui-input" style="width: 500px;">
    </div>
  </div>
