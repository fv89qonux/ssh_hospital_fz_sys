...
<head>
	<meta charset="utf-8">
	<title>医生管理--layui后台管理模板 2.0</title>
...
<body class="childrenBody">
	<blockquote class="layui-elem-quote quoteBox">
		<form class="layui-form">
			...
			<div class="layui-inline">
				<a class="layui-btn layui-btn-normal addLink_btn">添加医生信息</a>
			</div>
		</form>
	</blockquote>
	<table id="linkList" lay-filter="linkListTab">
		
	</table>
	<script type="text/javascript" id="username">
		{{# if(d.user!=null){}}
			{{d.user.username}}
		{{# } }}
	</script>
	
	<script type="text/javascript" id="password">
		{{# if(d.user!=null){}}
			{{d.user.password}}
		{{# } }}
	</script>
